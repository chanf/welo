...
| 建表脚本 | [0001_initial.sql](../migrations/0001_initial.sql) |
...
| 9 | feedback_rate_limits | 登录页留言限流记录表 | 10 万 |
...
| start_date | DATETIME | 是 | NULL | 开始时间，选填；分钟按 00 / 30 对齐 |
| end_date | DATETIME | 否 | 无 | 结束时间，必填；分钟按 00 / 30 对齐 |
